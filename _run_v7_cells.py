"""Run ONLY the 4 new code cells (§32-35) = code indices 31-34."""
...
# Run cells 31-34 (§32-35)
for idx in range(31, min(35, len(code_cells))):
    ...
    if out.strip():
        ...
        for line in lines[:180]:
            print(line)
        if len(lines) > 180:
            print(f"  ... ({len(lines)-180} more lines)")
    else:
        print("  (no output)")
...
print(f"\n\nDone. Updated outputs for cells 31-34 in _cell_outputs_v2.json")
